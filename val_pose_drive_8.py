#!/usr/bin/env python3
"""
Convenience launcher to validate the 8 MB model with Google Drive paths.

Uses val.py with the provided validation labels, images, and checkpoint:
- Checkpoint:       /content/drive/MyDrive/MLonMCU/Models/MAX78000/IP_8MB/best.pth
...
class StudentModel(nn.Module):
    """Compact student model using ai8x layers - 8 MB version"""
    def __init__(self):
        super().__init__()
        # Backbone
